 ...
 *
 * MEASURED 2026-08-27, not assumed: 81 color pairs at the WCAG AA floor, worst
...
export const BASE = {
  ...
  /* ONE WARM COLOR, AND `warn` IS AN ALIAS OF IT ON PURPOSE. A separate amber
     for caution beside a brass for chrome puts two close warm colors on screen
  ...
  info:      '#94ABC4',  // steel. Deliberately NOT a cyan — the retired identity
                         // was cyan and a visitor must not recognize it here.
  ...
  /* NO STATUS TINTS, and that is a finding rather than an omission. A shared
     ...
     NO COLORED LEFT EDGE EITHER, which replaced the tints for about an hour.
     ...
     most recognizable tell of a generated interface, which is the opposite of
