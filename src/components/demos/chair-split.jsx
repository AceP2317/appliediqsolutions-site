...
export default function ChairSplit({ mode = 'demo' }) {
  ...
  return (
    <div style={pageFor('chair-split')} data-demo="chair-split">
      <ToolHeader toolId="chair-split" house={SHOP} occasion="sample week" name="Booth Rent Calculator" status={status} restored={restored} pack={pack} remembers="rules and chairs">
                  ...
                  <tbody>
                    {r.rows.map((c, i) => (
                      <tr key={c.id} style={{ background: c.owesShop ? A.badTint : 'transparent' }}>
                        ...
                        {/* THE DEDUCTIONS, TOTALED AND THEN BROKEN OUT. The total is
