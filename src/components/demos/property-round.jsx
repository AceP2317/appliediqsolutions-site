...
// the same "how far past the interval" question the Recall Due List asks about a
...
export default function PropertyRound({ mode = 'demo' }) {
  ...
  return (
    <div style={pageFor('property-round')} data-demo="property-round">
      <ToolHeader toolId="property-round" house={CREW} occasion="sample round" name="Lawn Route Pricing Sheet" status={status} restored={restored} pack={pack} remembers="properties and crew cost">
