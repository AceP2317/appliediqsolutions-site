...
/* THE INDUSTRIAL FACEPLATE, "demand & planning" band — the deepest of the
   ...
   THE TWO-STOP GRADIENT SURVIVES; ITS TWO COLORS DO NOT. This file paints its
   ...
   costs no second color. So ACCENT2 becomes the dim brass, not a second hue.
...
/* Five root-cause categories. Steel, olive and orange do the work two invented
   hues used to; `Other` stays deliberately quiet rather than taking a color. */
...
/* THE PANEL LABEL, AND IT NOW CARRIES THE PANEL'S STATE.
   Six cards used to announce themselves with a 3-4px colored bar down their
   ...
   label sitting inside it saying the same thing in words. The color moves
