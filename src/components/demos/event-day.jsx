...
export default function EventDay({ mode = 'demo' }) {
  ...
  return (
    <div style={pageFor('event-day')} data-demo="event-day">
      <ToolHeader toolId="event-day" house={TRUCK} occasion="sample festival" name="Event Break-Even Calculator" status={status} restored={restored} pack={pack} remembers="menu and fixed costs">
      ...
      <div style={wrap}>
        ...
        <div className="aiq-split" style={{ '--aiq-split': '1.75fr' }}>
          <div>
            <Panel
              title="The menu"
