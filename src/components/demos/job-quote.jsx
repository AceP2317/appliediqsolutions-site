...
//
// A trade quotes a job standing in a driveway. Labor is hours against a rate.
...
// ways at once: hours on the labor lines, cost-plus on the parts.
//
...
// luck. Labor quantities are hundredths of an hour; parts quantities are what
// the supply house charged, in cents.
// ============================================================================
const SAMPLE = {
  number: '4417',
  rates: [
    { id: 'q1', key: 'Labor', basis: 'per-unit', perUnit: 9500, minimum: 14250 },
    { id: 'q2', key: 'Parts', basis: 'cost-plus', perUnit: 3500, minimum: null },
    { id: 'q3', key: 'Shop supply', basis: 'cost-plus', perUnit: 1000, minimum: 2500 },
  ],
  items: [
    { id: 'j1', label: 'Diagnose the return line', key: 'Labor', qty: 325, extra: 3500, actual: null },
    { id: 'j2', label: 'Swap the expansion valve', key: 'Labor', qty: 75, extra: 0, actual: null },
...
export default function JobQuote({ mode = 'demo' }) {
  ...
  return (
    <div style={pageFor('job-quote')} data-demo="job-quote">
      <ToolHeader toolId="job-quote" house={SHOP} occasion="sample job" name="Job Quote Calculator" badge={state.number} status={status} restored={restored} pack={pack} remembers="rate card">
      ...
      <div style={wrap}>
        ...
        <div className="aiq-split" style={{ '--aiq-split': '1.8fr' }}>
          <div>
            <Panel
              title="The job"
              note="On a labor line the quantity is hours. On a cost-plus line it is what the part cost you — the markup is added on top of it, not instead of it."
