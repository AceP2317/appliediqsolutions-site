...
/* british-ok: "Denise" is a person's name, and the -ise spelling rule reads any
   word ending in -ise as a candidate. A name is the one thing that spelling
   convention does not govern, which is exactly what the marker is for. */
export const MOCK_REVIEWS: Review[] = [
  {
    id: "1",
    platform: "google",
    author: "Denise M.", // british-ok: a person's name, not a spelling choice
    rating: 5,
    ...
    sampleReply: // british-ok: the same name, in the reply
