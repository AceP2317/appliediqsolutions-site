...
/* THE INDUSTRIAL FACEPLATE, "inbound & inventory" band. The warmest and
   ...
   `rgba(255,107,107,0.13)` — the risk color's own channels, keyed in a second
   time by hand. Move the risk color and the wash under it stayed where it
   was, with nothing erroring. alpha() takes the color from the token.
   ...
   used Tailwind's defaults and four used hand-picked slate. Three color
