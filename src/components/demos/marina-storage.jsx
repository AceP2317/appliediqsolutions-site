...
export default function MarinaStorage({ mode = 'demo' }) {
  ...
  return (
    <div style={pageFor("marina-storage")} data-demo="marina-storage">
      <ToolHeader toolId="marina-storage" house={YARD} occasion="sample month" name="Boat Storage Calculator" status={status} restored={restored} pack={pack} remembers="rate card">
