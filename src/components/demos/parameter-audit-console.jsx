...
const TGT = {
  /* THESE ARE TEXT, not chart fills: GeoBadge paints the tier name IN its own
     color on a 12% wash of itself. So each one has to clear the reading floor
...
/* THE INDUSTRIAL FACEPLATE, "master data & parameters" band — the cool
   ...
   FOUR SEVERITIES, THREE COLORS AND A GRAY. `LOW` takes the dim neutral
   rather than a fourth hue: a low finding is one you are not acting on today,
   and giving it a color makes a list of them look like an alarm board. */
const SEV = { CRITICAL: T.bad, HIGH: T.sevOrange, MEDIUM: T.sevOlive, LOW: T.textMuted };
/* Twelve verbs, five colors: raise it, ease it, do it now, look at it, tidy it. */
