...
export default function ReorderList({ mode = 'demo' }) {
  ...
  return (
    <div style={pageFor("reorder-list")} data-demo="reorder-list">
      <ToolHeader toolId="reorder-list" house={SHOP} occasion="sample stock list" name="Reorder Point Calculator" status={status} restored={restored} pack={pack} remembers="stock list">
