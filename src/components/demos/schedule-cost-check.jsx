...
// against the sales you expect and the labor share you have decided you want.
//
...
// labor-target benchmark, because what share of sales your payroll should be is
...
export default function ScheduleCostCheck({ mode = 'demo' }) {
  ...
  return (
    <div style={pageFor("schedule-cost-check")} data-demo="schedule-cost-check">
      <ToolHeader toolId="schedule-cost-check" house={HOUSE} occasion="sample week" name="Labor Cost Calculator" status={status} restored={restored} pack={pack} remembers="roster">
      ...
      <div style={wrap}>
        ...
        <div className="aiq-split" style={{ '--aiq-split': '1.7fr' }}>
          <div>
            <Panel
              title="The schedule"
            ...
            <Panel title="By role" note="Where the payroll actually sits. One blended figure hides whichever role moved.">
              {/* Five columns of headings do not fit 346px, and html/body carry
                  overflow-x: clip, so without this the last two are cut off with
