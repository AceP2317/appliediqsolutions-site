...
// is a decision about contracts, relationships and judgment, and no arithmetic
...
export default function StormHaulOut({ mode = 'demo' }) {
  ...
  return (
    <div style={pageFor("storm-haul-out")} data-demo="storm-haul-out">
      <ToolHeader toolId="storm-haul-out" house={YARD} occasion="sample haul-out" name="Haul-Out Capacity Planner" status={status} restored={restored} pack={pack} remembers="boat list">
      ...
      <div style={wrap}>
        {/* A QUIET INSET, NOT A WARNING, and the distinction is the point. This
            carried a faint brass wash from the dark era. Re-tokenizing it to the
        ...
        <div style={{
          ...
          relationships and judgment, and no arithmetic owns it. Change the order and it recounts.
        </div>
        ...
        <div className="aiq-split" style={{ '--aiq-split': '1.9fr' }}>
          ...
          <div>
            ...
            <WontDo items={[
              ...
              'It will not tell you which boat should go first. That is contracts, relationships and judgment, and no arithmetic owns it.',
