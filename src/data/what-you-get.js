/* ============================================================================
   ...
   ============================================================================ */
import { countWord as scopeCountWord, forgottenWord } from './website-scope.js';
/* THE CAREER FRACTION COUNTS ONE LIST SINCE 2026-09-13. Both halves used to be
   typed against a grouping nothing derived; the operator ruled the seven domains
   are the frame everywhere. */
import { tradeCountWord, streetFrontCountWord } from '../lib/trades.js';
...
/* THE COUNT IS DERIVED HERE TOO, 2026-09-13. This string is rendered into the
   PRINTED comparison sheet a client is handed, and it said "Six things ... five
   of them" while the scope it describes held seven. A number wrong on a web page
   is corrected by a deploy; the same number wrong on paper is in somebody's
   hands. */
export const buildIntro =
  ...
  `website. ${scopeCountWord({ capital: true })} things are in every build, and ${forgottenWord()} of them are the ` +
  'ones people forget until something breaks.';
...
export const whyThisOne = {
  ...
  run:
    'A restaurant floor at a casino for five and a half years, a bank’s lending division, cash management at a ' +
    'second bank, a clinic’s front office, a licensed insurance practice, and now the planning floor ' +
    `of the appliance plant in town. ${streetFrontCountWord({ capital: true })} of those ${tradeCountWord()} are on a New Bern street. Not advising any of ` +
    'them — running them.',
  points: [
    {
