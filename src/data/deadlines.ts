...
export const QUESTIONS = [
  ...
  { id: 'contractor', label: 'Do you hold a NC general contractor license?' },
];
...
export const DEADLINES: Deadline[] = [
  ...
  },
  {
    ...
    verified: '2026-08-25',
    appliesTo: ['alcohol'],
    teeth: 'A 25% late fee after 30 April, and the permit is permanently canceled if it is not renewed before 1 June. That is the hardest edge on this page.',
  },
  {
    id: 'cfpm',
  ...
  },
  {
    ...
    when: 'The CE year runs 1 January to 30 November — nothing is offered in December, so a license left to the last month cannot be brought current.',
...
export const HELD = [
  ...
  },
  {
    ...
    why: 'These exist in North Carolina only where the General Assembly has authorized them. No evidence was found either way for Craven, and "probably not" is not a thing to publish about somebody’s tax return.',
  },
];
