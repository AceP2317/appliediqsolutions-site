/* ============================================================================
   ...
   EVERY FIGURE WAS READ IN A BROWSER ON 2026-09-20 ON THAT COMPANY'S OWN PAGE,
   ...
   THE 2026-09-20 READ WAS NOT A REFRESH, IT WAS A REBUILD, and the difference is
   worth knowing before trusting any date in this file. D118 deleted this sheet on
   2026-09-20 and deleted its fifteen fee claims from the register with it. When
   the operator restored the sheet the same afternoon, the claims could have been copied
   back out of git in seconds — which would have carried a read date forward
   without a read. Every company below was opened again instead. Thirteen figures
   came back identical; one claim came back FALSE and was retired rather than
   restated, which is the Intuit line below.
   ...
   quoting a comparison somebody else published:
     ...
     - INTUIT FIXED ITS COMPARISON TABLE, AND THIS ENTRY NOW RECORDS THAT RATHER
       THAN THE OLD CATCH. On 2026-09-11 its table was stamped 30 April 2026 and
       carried two competitor figures that were wrong that day — Stripe ACH at
       1.2% against Stripe's published 0.8% capped at $5, and Square in person at
       2.6% + 10c against Square's 2.6% + 15c. Re-read on 2026-09-20: the stamp
       says 09/18/2026, the Stripe column is gone, and the Square figure is
       correct. THE CLAIM WAS RETIRED, NOT REWORDED. What is left is smaller and
       the page must not oversell it: a vendor's own comparison changes under you
       when it suits the vendor, and this one now omits the competitor whose ACH
       rate beats its own. That the omission is deliberate is NOT claimed, is not
       knowable from a page, and must never be written as though it were.
...
export const READ_ON = '20 September 2026';
