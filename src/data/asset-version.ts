 ...
 *
 * 17 — set 2026-09-23, when Staging Triage Console moved to the northpoint
 * palette and the house frame: its share card became the dark factory card with
 * its own picture, and its gallery tile was recaptured. Each of the seven moves
 * bumps this once as it lands.
 *
 * 18 — set 2026-09-24, ASN Update Radar's move: its dark factory card and its
 * recaptured gallery tile.
 *
 * 19 — set 2026-09-24, Past-Due Order Triage's move.
 *
 * 20 — set 2026-09-24, Production Plan Churn's move.
 *
 * 21 — set 2026-09-24, Order Confirmation Command Center's move.
 *
 * 22 — set 2026-09-24, BOM Explorer's move.
 *
 * 23 — set 2026-09-24, Parameter Audit Console's move, the seventh.
 */
