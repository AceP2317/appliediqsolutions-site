...
- [AI Fit Assessment](${origin}/ai-fit/): A paid assessment for a business that wants to use AI and cannot see where it fits. A read of how the work is actually done — on video, or in the business — and a written list of what is worth building with a price beside each line. ${assessmentPrice.video.line} ${assessmentPrice.video.qualifier} ${assessmentPrice.onSite.line} ${assessmentPrice.onSite.qualifier} ${assessmentPrice.rule} It is deliberately NOT a strategy deck, a maturity score, a roadmap or a vendor shortlist, and it does not assume the answer is AI.
