/* ============================================================================
   ...
   ONE MODULE, THREE SHEETS. /websites/compare/, /websites/getting-paid/ and
   /websites/selling-online/ — the last two sat at the top level until 2026-09-20
   and moved under the Websites door when they were restored on 2026-09-20 —
...
/* THREE SHEETS AGAIN FROM 2026-09-20. It was three until D118 cut the payments and
   store sheets on 2026-09-20, one for about three hours until the operator restored both
   under /websites/. The EXTRA entries above came back out of git verbatim, which
   matters more here than anywhere else on the page: the `wont` and `scoped` rows
   are refusals a client reads and a signed Scope stands behind, so a re-typed
   paraphrase would be a second wording of a promise. */
