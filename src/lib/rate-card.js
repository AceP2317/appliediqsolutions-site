/* ============================================================================
   RATE CARD — one engine, every tool that applies a rate to a line item.
   ...
   quotes a job from his own labor rates and his own markup on parts. A shop
   checks what a repair order should have billed at book hours against what it
   did bill. Those look like different jobs and they are the same
   arithmetic: take a line item,
   ...
   labor lines are hours times a rate, and the materials lines are what the part
...
export function computeRateCard(input) {
  ...
  /* A NEGATIVE MARKUP BILLS A PART BELOW WHAT IT COST, and the line still looks
     ...
     is not a judgment about whether a markup is high or low enough — the engine
