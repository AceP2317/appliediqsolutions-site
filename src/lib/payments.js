/* ============================================================================
   ...
   ONE LINK SINCE 2026-09-20 (D118), AND NO PAGE RENDERS IT, for the reason
   D118 kept: a link that does not exist yet is worse than no button, and the
   pay path stays an email until it does. The paragraph below is the record
   of the two-form period.

   THERE WERE TWO FROM 2026-09-06, AND NO PAGE RENDERED EITHER. The AI Fit
...
/** True when the one link is live. It took no default argument while there were
    two links, so that a default could not quietly pick one; with one form since
    2026-09-20 (D118) it is a plain question again. */
export const canTakeAnyPayment = () => canTakePayment(ASSESSMENT_VIDEO_PAYMENT_LINK);
