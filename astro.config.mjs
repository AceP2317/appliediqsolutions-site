  ...
  integrations: [
    ...
    sitemap({
      ...
      filter: (page) =>
        ...
        !page.includes('/meet') &&
        !page.includes('/host'),
      /* ONE DAILY PAGE, NOT TWO. This also named '/blog/', which was deleted on
         2026-08-24 — a branch that could never match, sitting in the file that
         tells crawlers what changes. Harmless and untrue, which is the pair that
         survives longest. */
      serialize: (item) => {
